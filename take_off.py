...
rocket_pos_init = vector(Earth.pos.x + R,Earth.pos.y,Earth.pos.z) #remeber that for regular orbit put h or R in place of (x,-,-)
#rocket object
...
v0 = 0.7*v_esc   #sqrt((G*M)/(R+h))  or   1.1*v_esc 
...
t=0 #time
#-+error for object detection of earth
e = 1e4
